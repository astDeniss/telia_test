...
from ...models.ticket import (TicketCreateResponse, EventTypeEnum,
                              ManyTicketsResponse, EventStatusEnum,
                              TicketCreateRequest, Ticket,
                              TicketEvent, TicketEventData,
                              TicketUpdateRequest, TicketUpdateResponse, TicketComment)
...
async def get_tickets(
    ...
    if assignee == None and status == None:
        ...
        ticket_docs = db[database_name][ticket_collection_name].find({'assignee': assignee, 'status': status},
